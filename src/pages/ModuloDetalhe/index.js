...
import {getCursoByUuid, protectedPmodulo} from "../../helpers/EasyLearnApi";
...
const ModuloDetalhe = () => {
    ...
    useEffect(()=>{
        protectedPmodulo(id,'Basic UHJvZmVzc29yOjEyMzQ1').then(function(result) {
        ...
        <section className="task-body">
         ...
         " id="menu-button-header">
                    ...
                    <div className="task-body-header-actions">
                        <a href={"/aula_detalhe="+modulo.aulaDto[0].id} aria-hidden="true"
                        ...
                        <div className="settings-box">
                            ...
                            <ul className="settings-box-list">
                                ...
                                <li className="settings-box-item settings-box-item-player">
                                    <a className="video-problems" href="/video/diagnostic?taskId=34189" target="_blank">
            ...
            <aside className="task-menu">
                <section className="task-menu-header">
                    ...
                    <div className="task-menu-header-info">
                        <a className="task-menu-header-info-title" href="/course/flappybirdunity1"
                ...
                <form className="task-menu-header-search" target="_blank" action="/search/course/flappybirdunity1"
                      method="get">
                    <label className="task-menu-header-search-title" htmlFor="query">Buscar neste curso</label>
                    <input className="task-menu-header-search-input" name="query" id="query" type="text" required=""/>
                                    ...
                                    <li className="task-menu-nav-item">
                                        <a href={"/aula_detalhe="+value.id}
                                           className="task-menu-nav-item-link task-menu-nav-item-link-VIDEO">
                                            <svg className="task-menu-nav-item-svg " aria-label="Atividade de Vídeo não concluída">
                                            </svg>
                                            ...
                                            <span className="task-menu-nav-item-text">
                                                  ...
                                                  <span className="task-menu-nav-item-videoDuration" title="Ir para o Vídeo">02min</span>
                                                  </span>
                                                  </span>
                                        </a>
                                    </li>
            ...
            <div className="task-body__wrapper">
                <section className="class-notes">
                    <div className="class-notes-content">
                        ...
                        <p className="class-notes-description">Este é seu caderno de anotações aqui na Alura. Todo o seu
                            conteúdo fica vísivel apenas para você. Próximos passos para essa funcionalidade no nosso<a
                                href="https://suporte.alura.com.br/article/308-meu-caderno-como-funciona"
                                className="class-notes-faq-link">FAQ</a></p>
                        <textarea name="text" id="courseNotebook-text" className="class-notes-text" cols="30" rows="10"
                ...
                <main className="task-body-main container" data-should-warn="false">
                    <section className="video" id="task-content">
                        <div className="container theater-mode">
                            ...
                            <iframe width="560" height="315" src={modulo.aulaDto[0].urlVideo}
            ...
            continuar lendo</span>
                    ...
                    <section className="task-actions">
                        <div className="container">
                            ...
                            <a href="/course/criacao-de-jogos-com-unity-3/task/34189/next"
                               className="task-actions-button task-body-actions-button task-actions-button-next bootcamp-next-button bootcamp-primary-button-theme">Próxima
                                Atividade</a>
                        </div>
                    </section>
                </main>
