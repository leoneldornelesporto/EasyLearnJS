    ...
    return(
            <footer className="footer container">
                ...
                <ul className="footer-menu">
                    ...
                    <li className="footer-menu-item">
                        <Link className="footer-menu-item-link" to="https://docs.google.com/forms/d/e/1FAIpQLScwKyaSvuFXK9SmMJoLPuYAS2qD_XAAnZPxMZij9qVeflbhBg/viewform" target="_blank">
                            Sugira um curso
                        </Link>
                    </li>
                    <li className="footer-menu-item">
                        <Link className="footer-menu-item-link" href="https://github.com/leoneldornelesporto/EasyLearn" target="_blank">
                            Sugira uma funcionalidade
                        </Link>
                    </li>
                    <li className="footer-menu-item">
                        <Link className="footer-menu-item-link" href="https://www.easylearn.com.br/artigos" target="_blank">
                            Blog do EasyLearn
                        </Link>
                    </li>
                </ul>
                    ...
                    <div className="footer-links">
                        ...
                        <ul role="presentation" className="footer-socialMedia">
                            <li className="footer-socialMedia-item">
                                <Link className="footer-socialMedia-item-link"
                            ...
                            <li className="footer-socialMedia-item">
                                <Link className="footer-socialMedia-item-link" href="https://twitter.com/easylearn"
                            ...
                            <li className="footer-socialMedia-item">
                                <Link className="footer-socialMedia-item-link" href="http://easylearn.hipsters.tech/" target="_blank"
                            ...
                            <li className="footer-socialMedia-item">
                                <Link className="footer-socialMedia-item-link" href="https://instagram.com/easylearn"
                    ...
                    <div className="footer-links">
                        ...
                        <ul className="footer-hotLinks-menu footer-hotLinks-mobile">
                            <li className="footer-hotLinks-item">
                                <Link className="footer-hotLinks-item-link"
